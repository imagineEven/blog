    ...
    return (
      <div className="page_part_2 background_fc">
        <div className="py_80 text_center">
          ...
          <p className="font_size22 color_80 font_lighter line_height15">根据门店个性需求，搭建智能门店管理系统，门店可以在线完成接单、获客、客户管理、<br className='line_br'/>员工管理、订单管理、配件采购、财务结算等日常运营工作。</p>
        </div>
          ...
          <div className="mx_auto inner_content_wrap">
            <div className="flexbox items_center product_service_part">
              <div className="w_50 text_center">
                <img className="w_100 max_img" src={require("../../../images/product/service_disc9.png")} alt="yilutong,壹路通"/>
                <div className="clearfix">
                  ...
                  <div className="w_50 text_center float_left">
                    <p className="mb_10 font_size20 color_80">门店SaaS系统</p>
                  </div>
                </div>
              </div>
              <div className="w_50">
